    ...
    <main className='max-w-[1240px] mx-auto- px-5 py-8 md:py-0'>
      <div className="h-dvh flex flex-col justify-center gap-16" > 
        <div className="flex flex-col gap-8 items-center md:items-start">
          ...
          <h1 className='text-4-l text-center leading-none font-heading font-medium flex flex-col md:text-7xl md:text-left'>
              ...
              <div className='flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6'> 
                <div className='flex items-center justify-between'>
                  ...
                  <p className='text-gray-300 leading-relaxed text-sm md:text-base' >
                    Um evento feito por e para pessoas desenvolvedoras apaixonadas por criar souluções inovadoras e compartilhar conhecimento. Vamos mergulhar nas tendências mais recentes em desenvolvimento de software, arquitetura de sistemas e tecnologias emergentes, com palestras, workshop e hackathons.
                    <br/>
                    <br/>                
                  </p>
              </div>
            <form className='bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6- w-full md:max-w-[440px]'>
                  <h2 className='font-heading font-semibold text-gray-200 text-xl'>Inscrição              
                  </h2>
